...
public class Main : SEScene
{
	...
	{
		base.initialize(rsc);
		bg = add_sprite_for_color(Color.instance("#008F47"),get_scene_width(),get_scene_height());
		bg.move(0,0);
	//  fg = add_sprite_for_color(Color.instance("#FF8533"),get_scene_width()*0.1, get_scene_height()*0.1);
		...
		rsc.prepare_image("mycat","cat3", get_scene_width()*0.20);
		 fg =  add_sprite_for_image(SEImage.for_resource("mycat"));
		fg.move(100,100);
